...
namespace CoreCnice.UtilsCs
{
    public class Utils
    {
        ...
        public static Guid CGuidDef(object Expression, string DefaultValue = "00000000-0000-0000-0000-000000000000")
        {
            ...
            {
                Guid guid = new Guid(DefaultValue);
                result = guid;
            }
            return result;
        }
        public static long CLngDef(object Expression, int DefaultValue = 0)
        {
            ...
            try
            {
                result = (long)Convert.ToInt32(Expression);
            }
            catch (Exception)
            {
        ...
        public static bool CBoolDef(object Experssion, bool DefaultValue = false)
        {
            ...
            try
            {
                result = Convert.ToBoolean(Experssion);
            }
            catch (Exception)
            {
                result = DefaultValue;
        ...
        public static decimal CDecDef(object Expression, [DecimalConstant(0, 0, 0u, 0u, 0u)] decimal DefaultValue = default(decimal))
        {
            decimal result;
            try
            {
        ...
        public static double CDblDef(object Expression, double DefaultValue = 0.0)
        {
            double result;
            try
            {
        ...
        public static string CStrDef(object Expression, string DefaultValue = "")
        {
            ...
            try
            {
                result = Expression.ToString().Trim();
            }
            catch (Exception)
            {
                result = DefaultValue;
        ...
        {
            bool tf = false;
            bool exists = System.IO.File.Exists("wwwroot/" + path);
            if (exists == true)
            {
                tf = true;
            }
        ...
        public static string GetProductName(object Title, int intLength)
        {
        ...
        public static string StripHTML(string source)
        {
            try
            {
                ...
                if (split.Count() > 0)
                {
                    ...
                    {
                        result += "<div class='col-sm-6 col-xs-12'><div class='counter d-flex align-items-center'><span class='counter__number'>" + (i + 1) + "</span><span class='counter__text'>" + split[i] + "</span></div></div>";
                    }
                }
                // That's it.
                return result;
